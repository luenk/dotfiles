...
" Setting up Plug - the vim plugin manager {{{
...
set scrolloff=8                   " Activate line 4 as top/bottom line for zt
...
set background=dark								" Set dark background for gruvbox
colorscheme gruvbox               " Set gruvbox color theme
" }}}
...
au filetype go inoremap <C-h> <C-x><C-o>
" }}}

" Basic key settings {{{
let loaded_matchparen = 1
let mapleader = " "
" Create mapping for system clipboard
vmap <Leader>y "+y
vmap <Leader>d "+d
nmap <Leader>y "+yy
nmap <Leader>d "+dd
...
vmap <Leader>p "+p
vmap <Leader>P "+P
"Create Leader z to toggle fold
nmap <Leader>z za
" Create matching close bracket
inoremap " ""<left>
inoremap ' ''<left>
inoremap ( ()<left>
inoremap [ []<left>
